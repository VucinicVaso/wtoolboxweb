...
import 'package:wtoolboxweb/ui_factory/component/button/underline_text/wtw_ui_button_underline_text.dart';

void main() {

  testWidgets(
    'WTWUIButtonUnderlineText component test', 
    (tester) async {
      double width          = 1000;
      ...
      WTWUIButton component = WTWUIButtonUnderlineText()
        ..setWidth(width)
